...
from libs.mailchimp.settings import API_KEY, SECURE, REAL_CACHE, CACHE_TIMEOUT
...
def dequeue(limit=None):
    from libs.mailchimp.models import Queue
    for camp in Queue.objects.dequeue(limit):
        yield camp

def is_queued_or_sent(object):
    from libs.mailchimp.models import Queue, Campaign
    object_id = object.pk
...
from libs.mailchimp.chimp import Connection
